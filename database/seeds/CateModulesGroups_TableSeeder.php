...
class CateModulesGroups_TableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $modelGroups->create([
            ...
            'display_order' => 1,
            'package_title_vi' => 'Xác thực bằng CMND',
            'package_title_en' => 'Xác thực bằng CMND',
            'package_type' => 1,
            'package_amount' => 0,
            'package_time' => 1,
            'status' => 1,
        ...
        $modelGroups->create([
            ...
            'display_order' => 2,
            'package_title_vi' => 'Xác thực bằng SMS',
            'package_title_en' => 'Xác thực bằng SMS',
            'package_type' => 2,
        ...
        $modelGroups->create([
            ...
            'display_order' => 3,
            'package_title_vi' => 'Xác thực bằng Bank',
            'package_title_en' => 'Xác thực bằng Bank',
            'package_type' => 3,
        ...
        $modelGroups->create([
            ...
            'display_order' => 4,
            'package_title_vi' => 'Đối Tác',
            'package_title_en' => 'Đối Tác',
            'package_type' => 4,
