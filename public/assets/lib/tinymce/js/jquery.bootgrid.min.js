...
! function(a, b, c) {
    ...
    if (I.defaults = {
            ...
            labels: {
                all: "All",
                infos: "Displaying Result ({{ctx.start}}) to ({{ctx.end}}) of {{ctx.total}} entries",
                loading: "Loading...",
            ...
            templates: {
                ...
                footer: '<div id="{{ctx.id}}" class="{{css.footer}}"><div class="row"><div class="text-center"><p class="{{css.pagination}}"></p></div></div></div>',
                header: '<div id="{{ctx.id}}" class="{{css.header}}"><div class="row"><div class="pull-left"><div class="box-results"><span class="toltal-results">Total Results: {{css.toltals}}</span><span class="{{css.infos}}"></span></div></div><div class="pull-right actionBar"><p class="{{css.search}}"></p><p class="{{css.actions}}"></p></div></div></div>',
