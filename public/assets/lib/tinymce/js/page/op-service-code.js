...
$(function() {
  ...
  if ($("#Tariff_TOGO_Upload_No").attr("checked")) {
    ...
    /*
    $("[name='selectVoucherIssue']").change(function() {   
      var voucherIssueValues = $("[name='selectVoucherIssue']").val();

      if (voucherIssueValues == 'on') {
        $("#txtRelatedTariffCode, #Btn_Setting_Related_Tariff_Code").prop('disabled', false);
      }
      if (voucherIssueValues == 'off') {
        $("#txtRelatedTariffCode, #Btn_Setting_Related_Tariff_Code").prop('disabled',true);
      }
    });*/
    
    $("[name='radioRiderFlag']").change(function() {   
      if ($('#radioRiderFlagOn').prop("checked")) {
        $("#txtRelatedTariffCode, #Btn_Setting_Related_Tariff_Code").prop('disabled', false);
      }
      if ($('#radioRiderFlagOff').prop("checked")) {
        $("#txtRelatedTariffCode, #Btn_Setting_Related_Tariff_Code").prop('disabled',true);
      }
    });
