...
<div class="container">
	...
	<div class="block-content" style="padding-bottom:50px">
		<div class="tab-content">
			@if(in_array(1, $tabSelected) && $tab_id != 7)
			...
			@if(in_array(7, $tabSelected) && $tab_id == 7)
