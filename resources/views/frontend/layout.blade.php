            ...
            <div class="block-header">
                <div class="row">
                            ...
                            <nav class="menu-top">
                                <ul class="nav-menu">
                                    ...
                                    @foreach ($arrListCate as $cate)
                                        <li class="level0"><a href="{{ route('realestate.category', [$cate->slug]) }}">{{ $cate->{'name_' . config('app.locale')} }}</a></li>
                                    @endforeach
                                </ul>
                            </nav><!-- /menu-top -->
                        </div><!-- /menu -->
                    ...
                    <div class="hdr-btn-post">
                        <a href="{{ route('member.realestate.create') }}" class="btn">Đăng tin miễn phí</a>
                    </div>
                </div>
                <div class="block-fb">
                    <div class="icon">
