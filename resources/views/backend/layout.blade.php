...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('public/admin/dist/css/skins/skin-blue.min.css') }}">
    <!-- iCheck -->
...
<!-- /.content-wrapper -->
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016-2020 <a
                    href="mailto:hoangnhonline@gmail.com">hoangnhonline@gmail.com</a>.</strong> All rights
        reserved.
    </footer>
    ...
    <input type="hidden" id="url_open_kc_finder"
           value="{{ URL::asset('public/admin/dist/js/kcfinder/browse.php?type=images') }}">
    <input type="hidden" id="url_open_kc_finder_files"
           value="{{ URL::asset('public/admin/dist/js/kcfinder/browse.php?type=files') }}">
