...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('public/admin/dist/css/skins/skin-blue.css') }}">
        <!-- iCheck -->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div style="display: none" id="box_uploadimages">
                    <div class="upload_wrapper block_auto">
                        ...
                        <form id="upload_files_new" method="post" enctype="multipart/form-data" enctype="multipart/form-data"
                              action="{{ route('ck-upload')}}">
                            <fieldset style="width: 100%; margin-bottom: 10px; height: 47px; padding: 5px;">
                                ...
                                <div class="progress_upload"
                                     style="text-align: center;border: 1px solid;border-radius: 3px;position: relative;display: none;">
                                    <div class="bar_upload"
                                         style="background-color: grey;border-radius: 1px;height: 13px;width: 0%;"></div>
                                    <div class="percent_upload" style="color: #FFFFFF;left: 140px;position: absolute;top: 1px;">0%
                                    </div>
                                </div>
                            </fieldset>
                        </form>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2016-2020 <a href="mailto:hoangnhonline@gmail.com">hoangnhonline@gmail.com</a>.</strong> All rights reserved.
            </footer>
        ...
        <!-- ./wrapper -->
        <!-- jQuery 2.2.3 -->
        <script type="text/javascript" src="{{ URL::asset('public/admin/plugins/jQuery/jquery-2.2.3.min.js') }}"></script>
        <!-- jQuery UI 1.11.4 -->
        <script type="text/javascript" src="{{ URL::asset('https://code.jquery.com/ui/1.10.0/jquery-ui.js') }}"></script>
        ...
        <!-- Bootstrap 3.3.6 -->
        <script type="text/javascript" src="{{ URL::asset('public/admin/bootstrap/js/bootstrap.min.js') }}"></script>
        <script type="text/javascript" src="{{ URL::asset('public/admin/dist/js/ajax-upload.js') }}"></script>
        <script type="text/javascript" src="{{ URL::asset('public/admin/dist/js/form.js') }}"></script>
        <script type="text/javascript" src="{{ URL::asset('public/admin/dist/js/sweetalert2.min.js') }}"></script>
        <script type="text/javascript" src="{{ URL::asset('public/admin/dist/js/select2.min.js') }}"></script>
        <script type="text/javascript" src="{{ URL::asset('public/admin/dist/js/es6-promise.min.js') }}"></script>
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>

        <!-- Slimscroll -->
        <script type="text/javascript" src="{{ URL::asset('public/admin/plugins/slimScroll/jquery.slimscroll.min.js') }}"></script>
        <!-- AdminLTE App -->
        <script type="text/javascript" src="{{ URL::asset('public/admin/dist/js/app.min.js') }}"></script>
