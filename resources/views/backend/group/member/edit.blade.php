...
<section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('group.member.index', ['group_id' => $userInfo->group_id]) }}" style="margin-bottom: 5px;">Quay lại</a>
    <div class="box box-primary">
        <form role="form" method="POST" action="{{ route('group.member.update', [$userInfo->id]) }}">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="email" name="email" value="{{ old('email', $userInfo->email) }}">
                        </div>
                        <div class="form-group">
                            <label>Tên truy cập<span class="red-star">*</span></label>
                            <input type="text" class="form-control" id="username" name="username" value="{{ old('username', $userInfo->username) }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Phone</label>
                            <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone', $userInfo->phone) }}">
                        </div>
                        <div class="form-group">
            ...
            <div class="box-footer">
                ...
                <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('group.member.index', ['group_id' => $userInfo->group_id]) }}">Hủy</a>
            </div>
        </form>
    </div>
</section>
