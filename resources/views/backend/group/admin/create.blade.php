...
<section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('group.admin.index', ['group_id' => $group_id]) }}" style="margin-bottom: 5px;">Quay lại</a>
    <div class="box box-primary">
        <form role="form" method="POST" action="{{ route('group.admin.store') }}">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        @if (count($errors) > 0)
            ...
            <div class="box-footer">
                ...
                <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('group.admin.index', ['group_id' => $group_id]) }}">Hủy</a>
            </div>
        </form>
    </div>
</section>
