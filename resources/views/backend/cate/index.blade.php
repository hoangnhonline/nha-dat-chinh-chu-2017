    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <a href="{{ route('cate.create', ['estate_type_id' => $estate_type_id, 'type' => $type]) }}" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
                        ...
                        <form class="form-inline" id="searchForm" role="form" method="GET" action="{{ route('cate.index') }}">   
                            ...
                            <div class="form-group">
                                <select class="form-control" name="estate_type_id" id="estate_type_id">
                                    ...
                                    {{ $estate_type_id == $value->id ? "selected" : "" }}                        
                                    >{{ $value->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr id="row-{{ $item->id }}">
                                    ...
                                    <td style="white-space:nowrap; text-align:right">
                                        <a class="btn btn-primary btn-sm" href="{{ route('danh-muc-con', [$item->estateType->slug, $item->slug ]) }}" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>     
